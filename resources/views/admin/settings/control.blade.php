            ...
            <div class="box box-danger">
                ...
                <form action="{{route('save_admin_control')}}" method="POST" role="form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="header_scripts">{{ tr('social_email_suffix') }}</label>
                            <input type="text" class="form-control" id="email_suffix" name="social_email_suffix" value="{{Setting::get('social_email_suffix')}}">
                        </div>
