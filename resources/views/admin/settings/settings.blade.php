                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="video_viewer_count" value="{{ Setting::get('video_viewer_count') }}" id="video_viewer_count" min="0" max="100" maxlength="100" pattern="[0-9]{0,}" placeholder="{{ tr('video_viewer_count_size_label') }}" step="any">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="amount_per_video" value="{{ Setting::get('amount_per_video') }}" min="0" max="100" maxlength="100" pattern="[0-9]{0,}" id="amount_per_video" placeholder="{{ tr('amount_per_video') }}" step="any">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="user_commission" value="{{ Setting::get('user_commission') }}" min="0" max="100" maxlength="100" pattern="[0-9]{0,}" id="user_commission" placeholder="{{ tr('moderator_commission') }}">
                                </div>
                            </div>
