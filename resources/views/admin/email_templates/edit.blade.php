	                ...
	                <div class="box-body">
	                	...
	                	<input type="hidden" name="template_id" value="{{ $template_details->id }}">
	                     ...
	                     <div class="form-group floating-label">
                            ...
                            <input type="hidden" required class="form-control" name="template_type" id="template_type" placeholder="{{ tr('enter') }} {{ tr('template_type') }}"  value="{{ $template_details->template_type }}">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <input type="text" required class="form-control" name="subject" id="heading" placeholder="{{ tr('enter') }} {{ tr('heading') }}" value="{{ $template_details->subject }}">
	                    </div>

	                    <div class="form-group">
	                        <label for="description">{{ tr('description') }}</label>

	                        <textarea id="ckeditor" required name="description" class="form-control" placeholder="{{ tr('enter') }} {{ tr('description') }}">{{ $template_details->description }}</textarea>
