                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="first">
                                        ...
                                        <ul class="form-style-7">
                                            <li>
                                                ...
                                                <input type="text" name="title" maxlength="100" maxlength="255" value="{{$admin_video_details->title}}" id='title'>
                                            </li>
                                            <li>
                                                <label for="age">{{tr('age')}} <span class="asterisk"><i class="fa fa-asterisk"></i></span></label>
                                                <input type="text" name="age" maxlength="3" value="{{$admin_video_details->age}}" id='age'>
                                            </li>
                                            <li>
                                                <label for="duration">{{tr('trailer_duration')}} <span class="asterisk"><i class="fa fa-asterisk"></i></span>(hh:mm:ss)</label>
                                                <input type="text" name="trailer_duration" maxlength="8" data-inputmask="'alias': 'hh:mm:ss'" data-mask value="{{$admin_video_details->trailer_duration}}" id="trailer_duration">
                                            </li>

                                            <li>
                                                <label for="duration">{{tr('main_video_duration')}} <span class="asterisk"><i class="fa fa-asterisk"></i></span>(hh:mm:ss)</label>
                                                <input type="text" name="duration" maxlength="8" data-inputmask="'alias': 'hh:mm:ss'" data-mask value="{{$admin_video_details->duration}}" id="duration">
                                            </li>
                                            ...
                                            <li id="time_li" style="display: none;width: 98%;">
                                                ...
                                                <input type="text" name="publish_time" id="datepicker" value="{{$admin_video_details->publish_time}}" readonly>
                                            </li> 
                                            
                                            <li>
                                                <label for="description">{{tr('description')}} <span class="asterisk"><i class="fa fa-asterisk"></i></span></label>
                                                <textarea name="description" rows="4">{{$admin_video_details->description}}</textarea>
                                            </li>

                                            <li>
                                              <label for="details">{{tr('details')}} <span class="asterisk"><i class="fa fa-asterisk"></i></span></label>

                                                <textarea name="details" rows="4" id='details'>{{$admin_video_details->details}}</textarea>
                                                ...
                                                <div class="">
                                                    <div class="">
                                                        <label class="">
                                                            ...
                                                            <input type="file" name="video" accept="video/mp4,video/x-matroska" id="video" @if(!$admin_video_details->id) required @endif/>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="checkbox checkbox-inline checkbox-primary">
                                                        <input type="checkbox" value="1" name="send_notification" @if(!$admin_video_details->id) checked @endif id="send_notification">
                                        ...
                                        <div>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4 image-upload">
                                                    ...
                                                    <input type="file" id="other_image1" accept=".png, .jpg, .jpeg" name="other_image1" placeholder="{{tr('other_image1')}}" style="display:none" onchange="loadFile(this,'other_img1')">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4 image-upload">
                                                    ...
                                                    <input type="file" id="other_image2" accept=".png, .jpg, .jpeg" name="other_image2" placeholder="{{tr('other_image2')}}" style="display:none" onchange="loadFile(this,'other_img2')">
    ...
    <script type="text/javascript">
       ...
       /* function saveVideo() {
        ...
        @if($admin_video_details->id && !$admin_video_details->status)
            ...
            $("#datepicker").val("{{$admin_video_details->publish_time}}");
