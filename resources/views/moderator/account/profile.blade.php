            ...
            <div class="box box-primary">
                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>{{tr('address')}}</b> <a class="pull-right">{{$moderator_details->address}}</a>
                        </li>
                    </ul>
                    ...
                    <div class="active tab-pane" id="profile_name">
                        ...
                        <form class="form-horizontal" action="{{(Setting::get('admin_delete_control') == 1) ? '' : route('moderator.save.profile')}}" method="POST" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="name"  name="name" value="{{$moderator_details->name}}" placeholder="{{tr('name')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="email" required value="{{$moderator_details->email}}" name="email" class="form-control" id="email" placeholder="{{tr('email')}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" required value="{{$moderator_details->mobile}}" name="mobile" class="form-control" id="mobile" placeholder="{{tr('mobile')}}" pattern="[0-9]{4,16}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" value="{{$moderator_details->address}}" name="address" class="form-control" id="address" placeholder="{{tr('address')}}">
                                </div>
                            </div>
